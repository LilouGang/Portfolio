    ...
    >
      <div className="flex justify-between items-center">
        ...
        <div className="flex space-x-5">
          <motion.a
            href="https://www.instagram.com/killian.lcq_/" target="_blank" rel="noopener noreferrer"
          ...
          <motion.a
            href="https://www.linkedin.com/in/killian-lacaque/" target="_blank" rel="noopener noreferrer"
            variants={iconVariants} initial="rest" whileHover="hover" transition={iconTransition}
            aria-label="LinkedIn"
          >
          ...
          <motion.a
            href="https://github.com/LilouGang" target="_blank" rel="noopener noreferrer"
            variants={iconVariants} initial="rest" whileHover="hover" transition={iconTransition}
            aria-label="GitHub"
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
